...
urlpatterns = [
                  ...
                  path('api/establishments/status/', views.get_all_establishments_status, name='get_all_establishments_status'),
                  ...
                  path('api/order/<int:order_id>/re-request/', views.re_request_order,
                       name='api_re_request_order'),
                  # ✅ Customer confirms they received their order (to_claim → completed)
                  path('api/orders/<int:order_id>/client-complete/', views.client_mark_completed,
                       name='api_client_mark_completed'),
                  ...
                  path('payment/upload-proof/', views.upload_payment_proof, name='upload_payment_proof'),
                  path('payment/verify-gcash/', views.verify_gcash_payment, name='verify_gcash_payment'),
                  path('payment/verification-status/', views.check_payment_verification_status, name='check_payment_verification_status'),
